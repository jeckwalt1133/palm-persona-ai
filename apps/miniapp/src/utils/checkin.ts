...
const CHECKIN_PARAGRAPHS: Record<number, string[]> = {
  1: [
    '第1天。AI发现你正在解锁一个隐藏副本。明天同一时间，你的手掌会说更多。',
    '签到成功。你的手掌档案已激活。明天来看看AI读出了什么。',
  ],
  2: [
    '连续签到第2天。你的手掌开始显现更多细节。AI说：你在建立一个新的习惯。',
  ...
  6: [
    '连续签到第6天。明晚有隐藏奖励——再签一天，你可以自选解锁一条深度解读线。',
    '第六天。坚持本身就是一种人格特质——明天有大事发生。',
  ],
  7: [
    '连续签到第7天！你获得了一次自选解锁资格——选一条你想深度了解的维度吧。',
    '一周了！你的坚持解锁了选择权——活力密码、思维密码、情感密码、行动密码，选哪个？',
  ],
};

const FALLBACK_PARAGRAPHS = [
  '签到成功。AI正在分析你的手掌特征——每天都有新洞察。',
